  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4 backdrop-blur-sm animate-fade-in" onClick={onClose}>
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden" onClick={(e) => e.stopPropagation()}>
        ...
        {/* Content */}
        <div className="p-8 overflow-y-auto font-sans text-gray-800 leading-relaxed">
            ...
            <div className="text-center mb-10 border-b border-gray-200 pb-8">
                ...
                <h1 className="text-3xl font-bold text-green-800 mb-2">Ospital ng Makati Antimicrobial Stewardship System</h1>
                <h2 className="text-xl text-gray-600">User Manual</h2>
                <p className="text-sm text-gray-500 mt-2">Digital Decision Support & Compliance Monitoring</p>
            </div>

            {/* 1. System Overview */}
            <section className="mb-8">
                <h3 className="text-xl font-bold text-green-700 mb-3 flex items-center gap-2">
                    <span className="bg-green-100 text-green-800 w-8 h-8 flex items-center justify-center rounded-full text-sm">1</span>
                    System Overview
                </h3>
            ...
            <section className="mb-8">
                <h3 className="text-xl font-bold text-green-700 mb-3 flex items-center gap-2">
                    <span className="bg-green-100 text-green-800 w-8 h-8 flex items-center justify-center rounded-full text-sm">2</span>
                    Getting Started
                </h3>
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <h4 className="font-bold text-gray-700 mb-2 text-sm">Login Credentials</h4>
                    <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            <tr><td className="py-2 font-medium">Resident / Physician</td><td>Submit Request</td><td className="font-mono text-gray-600">[None]</td></tr>
                            <tr><td className="py-2 font-medium">Pharmacist</td><td>Pending, History</td><td className="font-mono text-gray-600">********</td></tr>
                            <tr><td className="py-2 font-medium">ID Specialist (IDS)</td><td>Pending, History</td><td className="font-mono text-gray-600">********</td></tr>
                            <tr><td className="py-2 font-medium">AMS Admin</td><td>Data Analysis</td><td className="font-mono text-gray-600">********</td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
            ...
            <section className="mb-8">
                <h3 className="text-xl font-bold text-green-700 mb-3 flex items-center gap-2">
                    <span className="bg-green-100 text-green-800 w-8 h-8 flex items-center justify-center rounded-full text-sm">3</span>
                    Guide for Residents & Physicians
                </h3>
                <div className="space-y-2 text-sm text-gray-700 pl-2 border-l-4 border-green-200">
                    ...
                    <ul className="list-disc pl-6 text-gray-600">
                        <li><span className="text-blue-600 font-bold">Monitored:</span> Reviewed by Pharmacy.</li>
                        <li><span className="text-red-600 font-bold">Restricted:</span> Requires IDS approval.</li>
                    </ul>
            ...
            <section className="mb-8">
                <h3 className="text-xl font-bold text-green-700 mb-3 flex items-center gap-2">
                    <span className="bg-green-100 text-green-800 w-8 h-8 flex items-center justify-center rounded-full text-sm">4</span>
                ...
                <h4 className="font-bold text-gray-800 text-sm mb-1">Taking Action</h4>
            ...
            <section className="mb-8">
                <h3 className="text-xl font-bold text-green-700 mb-3 flex items-center gap-2">
                    <span className="bg-green-100 text-green-800 w-8 h-8 flex items-center justify-center rounded-full text-sm">5</span>
            ...
            <section className="mb-8">
                <h3 className="text-xl font-bold text-green-700 mb-3 flex items-center gap-2">
                    <span className="bg-green-100 text-green-800 w-8 h-8 flex items-center justify-center rounded-full text-sm">6</span>
                    Guide for AMS Admins
                </h3>
                
                <h4 className="font-bold text-gray-800 text-sm mt-3 mb-1 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-teal-600" viewBox="0 0 20 20" fill="currentColor"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" /><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" /></svg>
                    Data Analysis
                </h4>
                ...
                <h4 className="font-bold text-gray-800 text-sm mt-3 mb-1 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-teal-600" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clipRule="evenodd" /></svg>
                    AMS Audit Tool
                </h4>
            ...
            <section className="mb-8">
                <h3 className="text-xl font-bold text-green-700 mb-3 flex items-center gap-2">
                    <span className="bg-green-100 text-green-800 w-8 h-8 flex items-center justify-center rounded-full text-sm">7</span>
                    Troubleshooting
                </h3>
                <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1">
